...
inline struct WorkingSetElement* env_page_ws_list_create_element(struct Env* e, uint32 virtual_address)
{
	...
	//Your Code is Here...
	struct WorkingSetElement* new_workingset_element = (struct WorkingSetElement*)kmalloc(sizeof(struct WorkingSetElement));
	if(new_workingset_element == NULL)
	{
		panic("Failed to allocate new working set element");
	}
